# 🚀 Devops - Getting Started with Docker, Kubernetes, Vagrant, Ansible, Terraform and others  
...
01. Install WSL2 (with Updates)
02. Install Ubuntu 22. 04 from Microsoft Store
03. Log in to Ubuntu.
04. Optional - make your unix user be part of sudoers group with no passwd. (Ref any ubuntu how-to for this)
05. install git if not already installed  
   `sudo apt-get update && apt-get install -y git`
06. clone this directory and navigate to it. We will assume it's DevOps
07. make all .sh files excecutable\
   `bash
